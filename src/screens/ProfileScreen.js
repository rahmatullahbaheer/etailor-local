...
const ProfileScreen = () => {
  ...
  const [userName] = useState(data?.user?.user_name || "John Doe"); // This would come from user context/state
  const [userEmail] = useState(data?.user?.email || "john.doe@example.com");
